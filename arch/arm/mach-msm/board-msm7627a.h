...
enum {
	...
	GPIO_WLAN_EXT_POR_N     = GPIO_INVALID,
	GPIO_DISPLAY_PWR_EN     = GPIO_INVALID,
	GPIO_BACKLIGHT_EN       = GPIO_INVALID,
	GPIO_PRESSURE_XCLR      = GPIO_INVALID,
	GPIO_VREG_S3_EXP        = GPIO_INVALID,
	GPIO_UBM2M_PWRDWN       = GPIO_INVALID,
	GPIO_ETM_MODE_CS_N      = GPIO_INVALID,
	GPIO_HOST_VBUS_EN       = GPIO_INVALID,
	GPIO_SPI_MOSI       	= GPIO_INVALID,
	GPIO_SPI_MISO       	= GPIO_INVALID,
	GPIO_SPI_CLK       		= GPIO_INVALID,
	GPIO_SPI_CS0_N       	= GPIO_INVALID,
	GPIO_CORE_EXPANDER_IO13 = GPIO_INVALID,
	GPIO_CORE_EXPANDER_IO14 = GPIO_INVALID,
	GPIO_CORE_EXPANDER_IO15 = GPIO_INVALID,
	/* Camera expander */
	GPIO_CAM_EXPANDER_BASE  = GPIO_CORE_EXPANDER_BASE + 16,
	GPIO_CAM_GP_STROBE_READY= GPIO_CAM_EXPANDER_BASE,
	GPIO_CAM_GP_AFBUSY      = GPIO_INVALID,
	GPIO_CAM_GP_CAM_PWDN    = GPIO_INVALID,
	GPIO_CAM_GP_CAM1MP_XCLR = GPIO_INVALID,
	GPIO_CAM_GP_CAMIF_RESET_N= GPIO_INVALID,
	GPIO_CAM_GP_STROBE_CE   = GPIO_INVALID,
	GPIO_CAM_GP_LED_EN1     = GPIO_INVALID,
	GPIO_CAM_GP_LED_EN2     = GPIO_INVALID,
};

enum {
	QRD_GPIO_HOST_VBUS_EN       = GPIO_INVALID,
	QRD_GPIO_BT_SYS_REST_EN     = 19,
	QRD_GPIO_WAKE_ON_WIRELESS   = GPIO_INVALID,
	QRD_GPIO_BACKLIGHT_EN       = GPIO_INVALID,
	QRD_GPIO_NC       			= GPIO_INVALID,
	QRD_GPIO_CAM_3MP_PWDN       = GPIO_INVALID,/* CAM_VGA */
	QRD_GPIO_WLAN_EN       		= GPIO_INVALID,
	QRD_GPIO_CAM_5MP_SHDN_EN    = GPIO_INVALID,
	QRD_GPIO_CAM_5MP_RESET      = GPIO_INVALID,
	QRD_GPIO_TP       			= GPIO_INVALID,
	QRD_GPIO_CAM_GP_CAMIF_RESET = GPIO_INVALID,
};
