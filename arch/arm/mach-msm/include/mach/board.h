...
#define MSM_CAMERA_FLASH_SRC_LED (0x00000001<<4)
#define MSM_CAMERA_FLASH_SRC_LED1 (0x00000001<<5)
#define MSM_CAMERA_FLASH_SRC_LED2 (0x00000001<<6)
...
struct msm_camera_sensor_info {
	...
	uint8_t af_enable;//Jed,support YUV AF
};
