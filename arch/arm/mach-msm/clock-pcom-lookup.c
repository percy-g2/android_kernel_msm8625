...
static struct clk_lookup msm_cmn_clk_7625a_7627a[] __initdata = {
	...
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0036"),//'0-0036' is device id, 'cam_clk' is con id
...
#ifdef CONFIG_HM2056
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0048"),
#endif
#ifdef CONFIG_S5K4E1
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-006d"),
#endif
#ifdef CONFIG_HM2056_FRONT
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0049"),///0049 is i2c addr (0x24<<1 + 1)
#endif
#ifdef CONFIG_SP0A28_BACK
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-003f"),
#endif
#ifdef CONFIG_GC0313
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-002d"),
#endif
#ifdef CONFIG_S5K4EC
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-005a"),
#endif
#ifdef CONFIG_HM5065
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-003e"),
#endif
#ifdef CONFIG_OV2655
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0060"),//if can't lookup matched cam_clk error infor with dev_id such as '0-0060' will be printed in really_probe() of dd.c
#endif
#ifdef CONFIG_GC2035
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-007f"),
#endif
#ifdef CONFIG_GC2235
	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0078"),
#endif

#ifdef CONFIG_TCM9516MD 								  /* add new camera TCM9516*/
	CLK_LOOKUP("cam_clk",		cam_m_clk.c, 	"0-006f"),
#endif

#ifdef CONFIG_TCM9516MD_FRONT 							
		CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-0070"),
#endif

	CLK_LOOKUP("cam_clk",		cam_m_clk.c,	"0-006e"),
	//CLK_LOOKUP("cam_clk",		cam_m_clk.c,	NULL),//??
#ifdef CONFIG_SP0A28
...
#endif
#ifdef CONFIG_HM2056_FRONT
	CLK_LOOKUP("csi_clk",		csi0_clk.c, "msm_camera_hm2056front.0"),
	CLK_LOOKUP("csi_pclk",		csi0_p_clk.c,	"msm_camera_hm2056front.0"),
	CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c, "msm_camera_hm2056front.0"),
#endif

#ifdef CONFIG_TCM9516MD_FRONT
		CLK_LOOKUP("csi_clk",		csi0_clk.c, "msm_camera_tcm9516mdfront.0"),
		CLK_LOOKUP("csi_pclk",		csi0_p_clk.c,	"msm_camera_tcm9516mdfront.0"),
		CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c, "msm_camera_tcm9516mdfront.0"),
#endif
	...
	CLK_LOOKUP("core_clk",		sdc4_clk.c,	"msm_sdcc.4"),
	CLK_LOOKUP("iface_clk",		sdc4_p_clk.c,	"msm_sdcc.4"),
	CLK_LOOKUP("tsif_clk",		tsif_clk.c,	"msm_tsif.0"),	
	...
	CLK_LOOKUP("bus_clk",		ebi_grp_3d_clk.c, "kgsl-3d0.0"),
	CLK_LOOKUP("mem_clk",	ebi_lcdc_clk.c,	"lcdc.0"),
    CLK_LOOKUP("mem_clk",   ebi_lcdc_clk.c, "lcdc.196609"),              // this id is dev_id from the log in clk_get@drivers/clk/clkdev.c	
