...
/* +++ add for MID, MID has no SND_DEVICE_HANSET, use SND_DEVICE_SPEAKER_PHONE to replace it*/
...
/*~ SENTINEL snd_device_type.SND_DEVICE_MAX */
struct snd_ctxt {
	struct mutex lock;
	int opened;
...
static long snd_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case SND_SET_DEVICE:
		...
		/* +++ add for MID, MID has no SND_DEVICE_HANSET, use SND_DEVICE_SPEAKER_PHONE to replace it*/
		if ((SND_DEVICE_HANDSET == dev.device) || (SND_DEVICE_IN_S_SADC_OUT_HANDSET == dev.device))
			dev.device = SND_DEVICE_SPEAKER_PHONE;
		/* +++ add for MID, MID has no SND_DEVICE_HANSET, use SND_DEVICE_SPEAKER_PHONE to replace it*/
	...
	case SND_SET_VOLUME:
		...
		/* +++ add for MID, MID has no SND_DEVICE_HANSET, use SND_DEVICE_SPEAKER_PHONE to replace it*/
		if ((SND_DEVICE_HANDSET == vol.device) || (SND_DEVICE_IN_S_SADC_OUT_HANDSET == vol.device))
			vol.device = SND_DEVICE_SPEAKER_PHONE;
		/* +++ add for MID, MID has no SND_DEVICE_HANSET, use SND_DEVICE_SPEAKER_PHONE to replace it*/
