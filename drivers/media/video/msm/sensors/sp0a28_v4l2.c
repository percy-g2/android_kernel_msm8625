...
#define SP0A28_P0_0xdd	0x78 //0x80
#define SP0A28_P0_0xde	0x90 //0x80

//sharpness                          
#define SP0A28_P1_0xe8	0x18    //0x20//10//;sharp_fac_pos_outdoor
#define SP0A28_P1_0xec	0x28    //0x30//20//;sharp_fac_neg_outdoor
#define SP0A28_P1_0xe9	0x10//0a//;sharp_fac_pos_nr
#define SP0A28_P1_0xed	0x28    //0x30//20//;sharp_fac_neg_nr
...
//saturation
#define SP0A28_P0_0xd3	0x6c
#define SP0A28_P0_0xd4	0x6c
#define SP0A28_P0_0xd6	0x64
#define SP0A28_P0_0xd7	0x58
#define SP0A28_P0_0xd8	0x6c //0x90
#define SP0A28_P0_0xd9	0x6c //0x90
#define SP0A28_P0_0xda	0x64 //0x90
#define SP0A28_P0_0xdb	0x58
...
{0xfd,0x00},
	...
	{0xfd,0x00},
	//单通道间平滑阈值	
	{0x57,0x07},//0x04	//	;raw_dif_thr_outdoor  //20120915 Kavie
	{0x58,0x0c},//0x0a	// ;raw_dif_thr_normal      //20120915 Kavie
	{0x56,0x12},//0x10	// ;raw_dif_thr_dummy     //20120915 Kavie
	{0x59,0x12},//0x10	// ;raw_dif_thr_lowlight     //20120915 Kavie
	//GrGb平滑阈值
	{0x89,0x07},//0x04	//;raw_grgb_thr_outdoor    //20120915 Kavie
	{0x8a,0x0c}, //0x0a   //;raw_grgb_thr_normal      //20120915 Kavie
	{0x9c,0x12}, //0x10 //;raw_grgb_thr_dummy       //20120915 Kavie
	{0x9d,0x12}, //0x10 //;raw_grgb_thr_lowlight       //20120915 Kavie
	//Gr\Gb之间平滑强度
	{0x81,0xe0}, //   ;raw_gflt_fac_outdoor
	{0x82,0x90}, //;80;raw_gflt_fac_normal //0xa0
	{0x83,0x70}, //   ;raw_gflt_fac_dummy  //0x80
	{0x84,0x70}, //   ;raw_gflt_fac_lowlight  //0x80
	//Gr、Gb单通道内平滑强度  
	{0x85,0xe0}, //;raw_gf_fac_outdoor  
	{0x86,0x90}, //;raw_gf_fac_normal  //0xa0
	{0x87,0x70}, //;raw_gf_fac_dummy   //0x80
	{0x88,0x70}, //;raw_gf_fac_lowlight//0x80
	//R、B平滑强度  
	{0x5a,0xff},		//;raw_rb_fac_outdoor
	{0x5b,0xb0}, 		//;raw_rb_fac_normal//0xc0
	{0x5c,0x90}, 	  //;raw_rb_fac_dummy//0xa0
	{0x5d,0x90}, 	  //;raw_rb_fac_lowlight//0xa0
	//adt 平滑阈值自适应
	{0xa7,0xff},
	{0xa8,0xff},	//;0x2f
	{0xa9,0xff},	//;0x2f
...
static struct msm_camera_i2c_reg_conf sp0a28_saturation[][9] = {
	{{0xfd, 0x00}, {0xd3, SP0A28_P0_0xd3 - 0x6c}, {0xd4, SP0A28_P0_0xd4 - 0x6c}, {0xd6, SP0A28_P0_0xd6 - 0x64}, 
	{0xd7, SP0A28_P0_0xd7 - 0x58}, {0xd8, SP0A28_P0_0xd8 - 0x6c}, {0xd9, SP0A28_P0_0xd9 - 0x6c}, 
	{0xda, SP0A28_P0_0xda - 0x64}, {0xdb, SP0A28_P0_0xdb - 0x58},}, /* SATURATION LEVEL0*/
	
	{{0xfd, 0x00}, {0xd3, SP0A28_P0_0xd3 - 0x40}, {0xd4, SP0A28_P0_0xd4 - 0x40}, {0xd6, SP0A28_P0_0xd6 - 0x40}, 
	{0xd7, SP0A28_P0_0xd7 - 0x40}, {0xd8, SP0A28_P0_0xd8 - 0x40}, {0xd9, SP0A28_P0_0xd9 - 0x40}, 
	{0xda, SP0A28_P0_0xda - 0x40}, {0xdb, SP0A28_P0_0xdb - 0x40},}, /* SATURATION LEVEL1*/
	...
	{0xda, SP0A28_P0_0xda - 0x30}, {0xdb, SP0A28_P0_0xdb - 0x30},}, /* SATURATION LEVEL2*/
	...
	{0xda, SP0A28_P0_0xda - 0x20}, {0xdb, SP0A28_P0_0xdb - 0x20},}, /* SATURATION LEVEL3*/
	
	{{0xfd, 0x00}, {0xd3, SP0A28_P0_0xd3 - 0x10}, {0xd4, SP0A28_P0_0xd4 - 0x10}, {0xd6, SP0A28_P0_0xd6 - 0x10}, 
	{0xd7, SP0A28_P0_0xd7 - 0x10}, {0xd8, SP0A28_P0_0xd8 - 0x10}, {0xd9, SP0A28_P0_0xd9 - 0x10}, 
	{0xda, SP0A28_P0_0xda - 0x10}, {0xdb, SP0A28_P0_0xdb - 0x10},}, /* SATURATION LEVEL4*/
...
static struct msm_camera_i2c_reg_conf sp0a28_antibanding[][28] = {
	{
#ifdef preview_8_14_FPS	
//24 M 50hz 14-8fpx
//ae setting
...
static int sp0a28_msm_sensor_s_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
...
static int sp0a28_msm_sensor_s_iso_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
	struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	int rc = 0;
...
static int sp0a28_msm_sensor_s_awb_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
	struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	int rc = 0;
	unsigned short temp = 0;
...
static struct msm_sensor_v4l2_ctrl_info_t sp0a28_v4l2_ctrl_info[] = {
	{
...
static int32_t sp0a28_sensor_i2c_probe(struct i2c_client *client,
...
static int32_t sp0a28_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
...
static int32_t sp0a28_sensor_setting(struct msm_sensor_ctrl_t *s_ctrl,
