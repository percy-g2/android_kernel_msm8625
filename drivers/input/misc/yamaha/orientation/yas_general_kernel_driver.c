...
static DEVICE_ATTR(wake, S_IRUGO|S_IWUGO,
		NULL, sensor_wake_store);
static DEVICE_ATTR(data, S_IRUGO|S_IWUGO, sensor_data_show, NULL);
static DEVICE_ATTR(status, S_IRUGO|S_IWUGO, sensor_status_show, NULL);
