...
static DEVICE_ATTR(filter_threshold, S_IRUGO|S_IWUGO,
	geomagnetic_filter_threshold_show,
	geomagnetic_filter_threshold_store);
static DEVICE_ATTR(filter_noise, S_IRUGO|S_IWUGO,
	geomagnetic_filter_noise_show, geomagnetic_filter_noise_store);
static DEVICE_ATTR(data, S_IRUGO|S_IWUGO, geomagnetic_data_show, NULL);
static DEVICE_ATTR(status, S_IRUGO|S_IWUGO, geomagnetic_status_show, NULL);
static DEVICE_ATTR(wake, S_IRUGO|S_IWUGO, NULL, geomagnetic_wake_store);
...
#endif /* DEBUG */
static DEVICE_ATTR(info, S_IRUGO|S_IWUGO, driver_info_show, NULL);
